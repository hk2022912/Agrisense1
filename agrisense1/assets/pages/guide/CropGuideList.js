...
export default function CropGuideList() {
  ...
  const guides = [
    ...
    {
      id: 2,
      title: 'Organic Pest and Disease Management Guide',
    ...
    {
      id: 3,
      title: 'Companion Planting Technique Guide',
    ...
    {
      id: 4,
      title: 'Soil Moisture Management Guide',
      desc: 'Techniques to maintain the right soil moisture during dry and wet seasons.',
      img: require('../../images/rotation2.png'),
      screen: 'CropGuide4',
    },
    {
    ...
    {
      id: 6,
      title: 'Smart Irrigation Method Guide',
    ...
    {
      id: 7,
      title: 'Post-Harvest Handling and Storage Guide',
    ...
    {
      id: 8,
      title: 'Climate and Crop Suitability Guide',
    ...
    {
      id: 9,
      title: 'Weed Management Strategies Guide',
    ...
    {
      id: 10,
      title: 'Harvest Timing and Techniques Guide',
